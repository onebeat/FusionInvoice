...
class StartProvider extends ServiceProvider {
    ...
    public function register()
    {
        ...
        $app->bind('FI\Storage\Interfaces\ClientCustomRepositoryInterface', 'FI\Storage\Eloquent\Repositories\ClientCustomRepository');
        ...
        $app->bind('FI\Storage\Interfaces\InvoiceCustomRepositoryInterface', 'FI\Storage\Eloquent\Repositories\InvoiceCustomRepository');
        ...
        $app->bind('FI\Storage\Interfaces\PaymentCustomRepositoryInterface', 'FI\Storage\Eloquent\Repositories\PaymentCustomRepository');
        ...
        $app->bind('FI\Storage\Interfaces\QuoteCustomRepositoryInterface', 'FI\Storage\Eloquent\Repositories\QuoteCustomRepository');
